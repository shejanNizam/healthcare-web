...
//           <h4 className="text-2xl font-bold text-primary">Who We Are</h4>
//           <p className="text-lg text-gray-700 mt-4">
//             C.E.N.M. Healthcare is a nurse-led staffing agency built on family,
//             clinical excellence, and integrity. We proudly serve skilled nursing
//             facilities, hospitals, and home health agencies with reliable,
//             compassionate professionals.
//           </p>
//           <p className="text-lg text-gray-700 mt-4">
//             C.E.N.M. stands for Clement, Efua, Nathaniel, and Maxwell—our
//             founder, his wife, and their two sons. Our name is our mission: to
//             deliver care as if our own family depended on it.
//           </p>
//         </section>

//         <section className="mt-10">
//           <h4 className="text-2xl font-bold text-primary">Mission</h4>
//           <p className="text-lg text-gray-700 mt-4">
//             To provide dependable healthcare staffing that ensures every patient
//             receives exceptional care—wherever and whenever it’s needed.
//           </p>
//         </section>

//         <section className="mt-10">
//           <h4 className="text-2xl font-bold text-primary">Vision</h4>
//           <p className="text-lg text-gray-700 mt-4">
...
//         <section className="mt-10">
//           <h4 className="text-2xl font-bold text-primary">Core Values</h4>
//           <ul className="list-disc list-inside mt-4 text-lg text-gray-700">
//             <li>
//               <strong>Integrity:</strong> We do what’s right, always.
//             </li>
//             <li>
//               <strong>Compassion:</strong> People come first.
//             </li>
//             <li>
//               <strong>Excellence:</strong> No shortcuts. Only top-tier staff.
//             </li>
//             <li>
//               <strong>Accountability:</strong> We own every outcome.
//             </li>
//             <li>
//               <strong>Family:</strong> Built by family, run with heart.
//             </li>
//           </ul>
//         </section>
...
//           </h4>
//           <ul className="list-disc list-inside mt-4 text-lg text-gray-700">
//             <li>Fast, reliable staffing—without the stress.</li>
//             <li>Clinically-vetted, compassionate professionals.</li>
//             <li>Flexible, responsive, and relationship-driven.</li>
//           </ul>
//         </section>

//         <section className="mt-10 bg-blue-100 p-6 rounded-lg">
//           <p className="text-xl font-semibold text-center text-gray-800">
//             “We just don’t fill shifts - we build relationships that elevate
//             care. That’s the promise behind every name in C.E.N.M.”
//           </p>
...
//           </h4>
//           <p className="text-lg text-gray-700 mt-4">
//             Need trusted professionals or want to join our team? We’re ready to
//             help.
//           </p>
...
//           <h4 className="text-4xl font-extrabold text-primary text-center sm:text-left mb-6">
//             Who We Are
//           </h4>
//           <p className="text-xl text-gray-800 mt-4 leading-relaxed tracking-wide">
//             C.E.N.M. Healthcare is a nurse-led staffing agency built on family,
//             clinical excellence, and integrity. We proudly serve skilled nursing
//             facilities, hospitals, and home health agencies with reliable,
//             compassionate professionals.
...
//             Core Values
//           </h4>
//           <ul className="list-disc list-inside mt-6 text-xl text-gray-800 space-y-4">
//             <li>
//               <strong className="font-semibold">Integrity:</strong> We do what’s
//               right, always.
//             </li>
//             <li>
//               <strong className="font-semibold">Compassion:</strong> People come
//               first.
//             </li>
//             <li>
//               <strong className="font-semibold">Excellence:</strong> No
//               shortcuts. Only top-tier staff.
//             </li>
//             <li>
//               <strong className="font-semibold">Accountability:</strong> We own
//               every outcome.
//             </li>
//             <li>
//               <strong className="font-semibold">Family:</strong> Built by
...
//         <section className="mt-12 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-8 rounded-xl shadow-xl transform hover:scale-105 transition duration-300 ease-in-out">
...
//             <Link href="/apply-jobs">
//               <button className="bg-gradient-to-r from-green-400 to-teal-500 text-white font-semibold px-8 py-3 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
//                 Request Staffing
//               </button>
//             </Link>
//             <Link href="/contact">
//               <button className="bg-gradient-to-r from-orange-400 to-yellow-500 text-white font-semibold px-8 py-3 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
//                 Join Our Team
//               </button>
//             </Link>
//           </div>
