...
//         height: "600px",
//       }}
//       className="my-12 flex justify-around items-center"
//     >
//       <h3 className="flex-1"></h3>
//       <div className="flex-1">
//         <h1 className="text-5xl text-white font-bold w-[60%]">
//           <span className="bg-primary rounded p-1">Solving</span> The Biggest
//           Healthcare Workforce Challenges
//         </h1>
//         <p className="text-xl text-white my-8 w-[60%]">
//           We provide tech-enabled, proven solutions that enhance operating
//           margins and financial performance, increase workforce flexibility, and
